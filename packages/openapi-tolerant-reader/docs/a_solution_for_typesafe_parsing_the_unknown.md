...
# Problem Overview
We discuss the problem in more detail in [The Problem of Typesafe parsing the unknown with zod](./the_problem_of_typesafe_parsing_the_unknown_with_zod.md). 
...
And utilizing `.transform` with the context object `ctx`, the function will look like this:
